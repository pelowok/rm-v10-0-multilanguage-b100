    ...
    <div id="page-header" class="container bg-white no-pad no-margin absolute-75">
        <div class="row>">
            <div class="brand-logo">
                <img class="logo" src="images/MAXfocus_4color.png" alt=""/>
                <br>
                <div class="row">
                    ...
                    <div class="col-sm-push-6 col-sm-3 text-right">
                        <div class="well-lg main-form-block" id="form-container">
                                <!--<span>-->
                                    ...
                                    <div class="row">
                                        <a href="#formDiv" class="arrow-toggle btn btn-warning btn-block btn-lg active collapsed" data-toggle="collapse">
                                            Get your FREE 30-day Full Feature Trial
                                            <br>
                                            <span class="glyphicon glyph-lg glyphicon-collapse-up"></span>
                            ...
                            <div id="formDiv" class="collapse">
                                <form role="form" id="subscribe-form" class="subscribe-form">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="strInputEmail"
                                               placeholder="contact name">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="strInputCompany"
                                               placeholder="contact email">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="strInputCity"
                                               placeholder="city">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="strInputPostCode"
                                               placeholder="post/zip code">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="strInputPhone"
                                               placeholder="phone number">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="strInputURL"
                                               placeholder="website URL">
                                    </div>
                                    <button class="btn btn-lg btn-block btn-success " data-type="submit" href="">
                                        Try Now
                                    ...
                                    <span>
                                        <h6 style="color: #999999;">
                                            Join thousands of MSPs and IT support companies already thriving with LogicNow.
                                        </h6>
                                    </span>
                                </form>
                            </div>
